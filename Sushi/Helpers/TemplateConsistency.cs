...
namespace Sushi.Helpers
{
    ...
    {
        public static readonly Dictionary<TemplateKeyType, List<string>> KeysWithType = new Dictionary<TemplateKeyType, List<string>>
        {
            {TemplateKeyType.Comment, new List<string>
            {
                SUMMARY_KEY,
                TYPE_NAME_KEY,
                TYPE_NAMESPACE_KEY
            ...
            {TemplateKeyType.Validation, new List<string>
            {
                VALIDATION_KEY,
                IS_DEFINED_CHECK,
                IS_UNDEFINED_CHECK
