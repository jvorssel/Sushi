...
public static class ConverterExtensions
{
    ...
    {
        return new EcmaScript5Converter(converter, options ?? new ConverterOptions());
    }
    ...
    {
        return new EcmaScript6Converter(converter, options ?? new ConverterOptions());
    }
    ...
    {
        return new TypeScriptConverter(converter, options ?? new TypescriptConverterOptions());
    }
}